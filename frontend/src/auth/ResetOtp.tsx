			...
			<div className="grid min-h-screen grid-cols-1 lg:grid-cols-2">
				<aside className="relative hidden flex-col justify-between p-8 sm:p-10 lg:flex lg:p-12 xl:p-14">
					...
					<div className="auth-branding relative z-10">
						<h1 className="text-4xl font-black leading-none tracking-tight uppercase sm:text-5xl xl:text-6xl">
							Security Check.<br />
							<span className="text-[#C6A664]">One More Step.</span>
						</h1>
				...
				<div className="relative flex min-h-screen flex-col justify-between px-4 py-4 sm:px-6 md:px-10 lg:px-10 lg:py-6 xl:px-12 xl:py-8">
					...
					<div className="auth-form relative z-10 mx-auto my-auto w-full max-w-md py-2">
						<div className="p-1">
							<div className="mb-3">
								<p className="text-xs font-black tracking-[0.25em] text-[#C6A664] uppercase">Verify OTP</p>
								<h2 className="mt-1 text-2xl font-black tracking-tight sm:text-3xl">Enter your reset code</h2>
							...
							<form onSubmit={handleSubmit} className="space-y-2.5">
								<label className="block">
									<span className="mb-1 block text-xs font-bold tracking-[0.12em] text-neutral-300 uppercase">6-Digit Code</span>
									<input
										type="text"
										inputMode="numeric"
										pattern="[0-9]{6}"
										...
										placeholder="123456"
										className="w-full rounded-xl border border-neutral-800 bg-neutral-950/90 px-4 py-3 text-center text-lg tracking-[0.5em] outline-none focus:border-[#C6A664]"
									/>
								</label>
								...
								<button
									...
									className="w-full text-xs font-semibold text-[#C6A664] hover:text-white disabled:opacity-50"
								>
								...
								>
									<span>{isSubmitting ? 'Please wait...' : 'Verify OTP'}</span>
